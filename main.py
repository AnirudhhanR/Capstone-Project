...
import math
import time
import final_traffic_exponential
# import new_adaptive
import dijkstra
...
for abc in range(0,100):
    ...
    def xy_routing(src, dest, n):
        if(src!=dest):
            ...
            for i in range(len(path) - 1):
                ...
                node1 = nodes[x1][y1]
                node2 = nodes[x2][y2]
                data_generator = final_traffic_exponential.generate_data()
    ...
    n = 64
     #int(input("Enter number of bits that you want to send between source node and destination node:"))
...
print(testingdata)
testingdata.to_csv("D:/Capstone/Capstone-Project-Master/Capstone-Project/TESTING/EXPONENTIAL/0_to_15_bitsize_64.csv")
