...
# Reading dataframes 
vc5 = pd.read_csv('C:/Users/Deepa V/Downloads/traffic/RANDOM_TRAFFIC/0_to_15_bitsize_5.csv')
vc20 = pd.read_csv('C:/Users/Deepa V/Downloads/traffic/RANDOM_TRAFFIC/0_to_15_bitsize_20.csv')
vc40 = pd.read_csv('C:/Users/Deepa V/Downloads/traffic/RANDOM_TRAFFIC/0_to_15_bitsize_40.csv')
...
for ax, data, label, color in zip(axs1, [dynamic_xy5, dynamic_adaptive5, vc5], labels, colors):
    x_values = np.arange(len(data['Total Hopcount']))
    y_values = np.array(data['Total Hopcount'])
