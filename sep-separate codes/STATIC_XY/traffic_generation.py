...
def generate_random_traffic():
    return np.uint64(2**np.random.randint(0, 64))
...
def generate_data():
   # while True:
        ...
        # print("t0_1:2^%.2f" % math.log2(t0_1))
        # print("t1_2:2^%.2f" % math.log2(t1_2))
        # print("t2_3:2^%.2f" % math.log2(t2_3))
        # print("t4_5:2^%.2f" % math.log2(t4_5))
        # print("t5_6:2^%.2f" % math.log2(t5_6))
        # print("t6_7:2^%.2f" % math.log2(t6_7))
        # print("t8_9:2^%.2f" % math.log2(t8_9))
        # print("t9_10:2^%.2f" % math.log2(t9_10))
        # print("t10_11:2^%.2f" % math.log2(t10_11))
        # print("t12_13:2^%.2f" % math.log2(t12_13))
        # print("t13_14:2^%.2f" % math.log2(t13_14))
        # print("t14_15:2^%.2f" % math.log2(t14_15))
        # print("t0_4:2^%.2f" % math.log2(t0_4))
        # print("t1_5:2^%.2f" % math.log2(t1_5))
        # print("t2_6:2^%.2f" % math.log2(t2_6))
        # print("t3_7:2^%.2f" % math.log2(t3_7))
        # print("t4_8:2^%.2f" % math.log2(t4_8))
        # print("t5_9:2^%.2f" % math.log2(t5_9))
        # print("t6_10:2^%.2f" % math.log2(t6_10))
        # print("t7_11:2^%.2f" % math.log2(t7_11))
        # print("t8_12:2^%.2f" % math.log2(t8_12))
        # print("t9_13:2^%.2f" % math.log2(t9_13))
        # print("t10_14:2^%.2f" % math.log2(t10_14))
        # print("t11_15:2^%.2f" % math.log2(t11_15))
       #
        ...
        # Rest of your code...
        # (The path calculation and delay calculation)
        
        # Introduce a delay between consecutive traffic generations
        time.sleep(3)  # 3seconds, you can adjust this value as needed